...
import (
	...
	apisCluster "github.com/IonitaCatalin/provider-hcloud/apis/cluster"
	apisNamespaced "github.com/IonitaCatalin/provider-hcloud/apis/namespaced"
	"github.com/IonitaCatalin/provider-hcloud/config"
	"github.com/IonitaCatalin/provider-hcloud/internal/clients"
	controllerCluster "github.com/IonitaCatalin/provider-hcloud/internal/controller/cluster"
	controllerNamespaced "github.com/IonitaCatalin/provider-hcloud/internal/controller/namespaced"
	"github.com/IonitaCatalin/provider-hcloud/internal/features"
	"github.com/IonitaCatalin/provider-hcloud/internal/version"
)
...
func main() {
	...
	kingpin.FatalIfError(apisCluster.AddToScheme(mgr.GetScheme()), "Cannot add cluster-scoped HCloud APIs to scheme")
	kingpin.FatalIfError(apisNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add namespaced HCloud APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated(mgr, clusterOpts), "Cannot setup cluster-scoped HCloud controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated(mgr, namespacedOpts), "Cannot setup namespaced HCloud controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup(mgr, clusterOpts), "Cannot setup cluster-scoped HCloud controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup(mgr, namespacedOpts), "Cannot setup namespaced HCloud controllers")
	}
